...
<body>
    ...
    <main>
        <div class="header">Shikshan</div>
        <hr>

        <div class="container">
            <br>
            <div class="center">
                <a href="add-project.php?project=Shikshan" class="btn-primary">New Project</a>
            </div>
            <br>
    ...
    <script>
        ...
        const handleDelete = (project) => {
            if (confirm("Do you really want to delete?")) {
                window.location.href = "api/api_deleteProject.php?project=" + project + "&type=shikshan";
            }
        }
