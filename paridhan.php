...
<body>
    ...
    <main>
        <div class="header">Paridhan</div>
        <hr>

        <div class="container">
            <br>
            <div class="center">
                <a href="add-project.php?project=Paridhan" class="btn-primary">New Project</a>
            </div>
            <br>
    ...
    <script>
        const setProjects = (projects) => {
            ...
            projects.forEach(project => {
                // Using backticks to properly form template literals
                template += `
                <tr>
                    <td>${project.name}</td>
        ...
        const handleDelete = (project) => {
            if (confirm("Do you really want to delete?")) {
                window.location.href = "api/api_deleteProject.php?project=" + project + "&type=paridhan";
            }
        }
